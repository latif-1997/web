								...
								<div class="row">
									...
									while($i = mysqli_fetch_array($customer)){
										...
										<div class="form-group">
											<label>Nama</label>
											<input type="text" class="input" name="nama" value="<?php echo $i['customer_nama'] ?>" placeholder="Masukkan nama pemesan .." required="required">
										</div>
										
										<div class="form-group">
											<label>Nomor HP</label>
											<input type="number" class="input" name="hp" value="<?php echo $i['customer_hp'] ?>" placeholder="Masukkan no.hp aktif .." required="required">
										</div>
										
										<div class="form-group">
											<label>Alamat Lengkap</label>
											<textarea name="alamat" class="form-control" style="resize: none;" rows="6" placeholder="Masukkan alamat lengkap .."><?php echo $i['customer_alamat'] ?></textarea>
										</div>
										<?php 
									}
									?>
										...
										curl_setopt_array($curl, array(
											...
											CURLOPT_HTTPHEADER => array(
												"key: 919eb789d6e795e424c6898b2990e99a"
											),
										));
